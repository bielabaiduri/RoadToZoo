  ...
  if(isset($_POST['btn_login']))
  {
    ...
    {   
      ...
      if (mysqli_num_rows($result) == 1) 
      {
		  ...
		  if(isset($_POST["isMobileView"]))
		{
			$_SESSION["isMobileView"] = $_POST["isMobileView"];
			 print "<script>";
          print " self.location='~/../webview/viewbooking.php';"; 
          print "</script>";  
		}
		else
		{
...
<div id="page">
  <div id="header"> <a href="#" id="logo"><img src="images/logo-page.jpg" alt=""/></a>
    <ul id="navigation">
      ...
      <li id="link5" class="selected"><a href="login.php">Member</a></li>
